...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/tutorialwindoxIk/Ishuxd",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/somueditingzone"
)  # Example:- https://t.me/somueditingzone 
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/+7kCwP6b4qEkxZjZl"
)  # Example:- https://t.me/somueditingzone 
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://envs.sh/0d0.mp4":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://envs.sh/0dq.jpg":
